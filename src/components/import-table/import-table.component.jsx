      ...
      {dataTable && dataTable.length > 0 && (
        <div>
          <div className='import-notice'>
            Cocher le dernier champ d'une ligne et mettre un nom aux champs à
            importer
          </div>
          ...
          <div className='import-line-body'>
            {dataTable
              ...
              .map((dataLine, idx) => {
                const field =
                  tabFields &&
                  idx < tabFields.length &&
                  tabFields[idx] !== 'undefined'
                    ? tabFields[idx]
                    : '';
                const line = {
                  id: idx,
                ...
                return <ImportLine key={idx} idx={idx} line={line} />;
              })}
          </div>
        </div>
      )}
