...
const SupplierList = () => {
  const { suppliers, onLineEdit, toggleLineEdit } = useContext(SupplierContext);
  ...
  return (
    <div className='supplier-list'>
      <div className='title'>Liste des fournisseurs</div>
